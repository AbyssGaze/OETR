...
_CN.SADNET.NECK.MAX_SHAPE = (100, 100)  # max feature map shape, with image shape: max_shape*stride
...
_CN.DATASET.TRAIN.DATA_SOURCE = 'megadepth'  # options: ['megadepth_pairs', 'megadepth']
...
_CN.DATASET.VAL = CN()
_CN.DATASET.VAL.DATA_SOURCE = 'megadepth'  # options: ['megadepth_pairs', 'megadepth']
